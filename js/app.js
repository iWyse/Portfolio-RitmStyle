...
***************************************************************************** */
    ...
    ymaps.ready((function() {
        var myMap = new ymaps.Map("map", {
            center: [ 59.946849987667335, 30.292069002441405 ],
            zoom: 12,
            controls: [ "smallMapDefaultSet" ],
            behaviors: [ "drag" ]
        }, {
            searchControlProvider: "yandex#search"
        }), myPlacemark = new ymaps.Placemark([ 59.926854757960534, 30.31919149999999 ], {
            hintContent: "Метро Спасская",
            balloonContent: "Один из способов добраться до RitmStyle - Метро Спасская"
        }, {
            iconLayout: "default#image",
            iconImageHref: "img/icons/map.svg",
            iconImageSize: [ 30, 38 ]
        }), myPlacemarkTwo = new ymaps.Placemark([ 59.97179825773768, 30.25938199999995 ], {
            hintContent: "Крестовский остров",
            balloonContent: "Один из способов добраться до RitmStyle - Метро Крестовский остров"
        }, {
            iconLayout: "default#image",
            iconImageHref: "img/icons/map.svg",
            iconImageSize: [ 30, 38 ]
        });
        myMap.geoObjects.add(myPlacemark).add(myPlacemarkTwo);
    }));
    AOS.init();
    window["FLS"] = true;
    isWebp();
